...
import 'package:thriftit/constants/error_handling.dart';
import 'package:thriftit/constants/global_variables.dart';
import 'package:thriftit/constants/utils.dart';
import 'package:thriftit/features/admin/models/sales.dart';
    ...
    try {
      ...
      httpErrorHandle(
        ...
        onSuccess: () {
          ...
          sales = [
            Sales('Tshirt', response['TshirtEarnings']),
            Sales('Shirt', response['ShirtEarnings']),
            Sales('OnePiece', response['OnepieceEarnings']),
            Sales('Pant', response['PantEarnings']),
            Sales('Jacket', response['JacketEarnings']),
